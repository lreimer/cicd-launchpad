...
public interface CiCdServer {
     ...
     */
    static CiCdServer jenkins(File config, String username, String password, long time, TimeUnit timeUnit) {
        return new JenkinsCiCdServer(config, username, password, time, timeUnit);
    }
